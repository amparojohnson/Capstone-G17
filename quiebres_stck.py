...
all_inventory = {}
for item_id in df_items['item_id']:
...
print("Categorías de producto con más quiebres de stock:")
print(category_stock_breaks)
...
print(product_stock_breaks.head(10))
